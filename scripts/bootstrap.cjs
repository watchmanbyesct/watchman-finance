...
const SYSTEM_PERMISSIONS = [
  ...
  "ar.payment.apply", "ar.collection.manage",
  "ap.bill.create", "ap.bill.approve", "ap.payment.release", "ap.recurring.manage",
  "payroll.run.create", "payroll.run.calculate", "payroll.run.approve",
  "payroll.run.finalize", "payroll.run.reverse", "payroll.profile.manage", "payroll.ach.generate",
  ...
  "catalog.category.manage", "catalog.item.manage", "catalog.price.manage",
  "billing.rule.manage", "billing.candidate.manage",
  "inventory.category.manage", "inventory.location.manage", "inventory.item.manage", "inventory.adjustment.post",
  "reporting.definition.manage",
  "planning.budget.manage", "planning.forecast.manage",
