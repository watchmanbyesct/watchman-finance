export const metadata = { title: "Pricing Rules — Watchman Finance" };

export default function Page() {
  return (
    <div className="max-w-5xl space-y-6">
      <div>
        <h1 className="wf-page-title">Pricing Rules</h1>
      ...
      <div className="wf-card border-amber-500/20 bg-amber-500/5">
        ...
        <p className="text-sm text-neutral-400">
          ...
          and seeded. Build this screen in the sprint for Products & Services.
        </p>
      </div>
    </div>
  );
