...
const WORKFLOWS: { href: string; label: string; permission: string; wiring: string }[] = [
  {
    ...
    wiring: "Lists + CatalogCategoryForm / CatalogItemForm → createCatalogCategory, createCatalogItem",
  },
  {
    href: "/finance/catalog/pricing",
    label: "Catalog — pricing",
    permission: "catalog.price.manage",
    wiring: "List + CatalogPriceForm → createCatalogItemPrice",
  },
  {
    href: "/finance/billing/rules",
    label: "Billing — rules",
    permission: "billing.rule.manage",
    wiring: "List + BillingRuleForm → createBillingRule",
  },
  {
    href: "/finance/billing/candidates",
    label: "Billing — candidates",
    permission: "billing.candidate.manage",
    wiring: "List + BillableCandidateForm → createBillableCandidate",
  },
  {
    href: "/finance/billing/exceptions",
    label: "Billing — exceptions",
    permission: "billing.rule.manage",
    wiring: "List + BillingExceptionResolveForm → resolveBillingException",
  },
  {
